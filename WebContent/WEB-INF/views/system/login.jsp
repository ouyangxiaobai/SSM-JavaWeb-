...
<title>登录|基于JavaWeb在线投票系统</title>
<meta name="keywords" content="学生信息管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">基于JavaWeb在线投票系统</h2>
</div>
    ...
    <form id="login-form" class="form form-horizontal" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="username" name="username" type="text" placeholder="账户" class="input-text size-L" data-options="required:true, missingMessage:'用户名不能为空'">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright &nbsp;  @ 基于JavaWeb在线投票系统 </div>
